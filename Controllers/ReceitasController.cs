...
namespace ReceitasMvc.Controllers
{
    ...
    {
        private readonly ReceitasMvcContext _context;

        public ReceitasController(ReceitasMvcContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Titulo,Preparo")] Receita receita)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Titulo,Preparo")] Receita receita)
        {
            if (id != receita.Id)
            {
                return NotFound();
